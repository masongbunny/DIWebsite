...
<html lang="en">
    ...
    <head>
        ...
        <title>Super Admin Section - Edit Rank</title>
        ...
        <div class="admin-wrapper">
            ...
            <div class="admin-content">
                <div class="button-group">
                    <a href="rankindex.php" class="btn btn-big">Cancel</a>
                </div>
                <div class="content">
                    <h2 class="page-title">Edit Rank</h2>
                    ...
                    <form action="create.php" method="post">
                        ...
                        <div>
                            ...
                            <input type="text" name="rank" value="<?php echo $rank; ?>" class="text-input" required>
                        </div>
                        <div>
                            <button type="submit" name="update-rank" class="btn btn-big">Update</button>
                        </div>
                    </form>
                </div>
            </div>
