...
<html lang="en">
    ...
    <head>
        ...
        <title>Faculty Section - Update Account Info</title>
        ...
        <div class="admin-wrapper">
            ...
            <div class="admin-content">
                <div class="button-group">
                    <a href="dashboard.php" class="btn btn-big">CANCEL</a>
                </div>
                <div class="content">
                    ...
                    <form action="edit.php" method="post">
                        ...
                        <div>
                            <button type="submit" name="update-chairperson" class="btn btn-big">Update Info</button>
                        </div>
                    </form>
                </div>
            </div>
