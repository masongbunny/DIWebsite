...
<html lang="en">
    ...
    <head>
        ...
        <title>Super Admin Section - Add Admin User</title>
                ...
                <div class="content">
                    ...
                    <form action="create.php" method="post">
                        ...
                        <div>
                            ...
                            <input type="text" name="lastname" value="<?php echo $lastname; ?>" class="text-input" required>
                        </div>
                        <div>
                            <label>First Name</label>
                            <input type="text" name="firstname" value="<?php echo $firstname; ?>" class="text-input" required>
                        </div>
                        <div>
                            <label>Email</label>
                        ...
                        <div>
                            ...
                            <select name="position" class="text-input" required>
