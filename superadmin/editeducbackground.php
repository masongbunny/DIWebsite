            ...
            <div class="admin-content">
                ...
                <div class="content dp-box1">
                    ...
                    <?php include(ROOT_PATH . "/app/helpers/formErrors.php"); ?>
                        <form action="editeducbackground.php" method="post">
                            <div>
                                ...
                                <input type="text" name="orgname" value="<?php echo $orgname; ?>" class="text-input">
                            </div>
                            <div>
                                <label>Course/Specialization</label>
                                <input type="text" name="course" value="<?php echo $course; ?>" class="text-input">
                            </div>
                            <div>
                                <label>Start Year <span class="note">(Leave blank if you are not updating the Start Year)</span></label>
                                <input type="number" maxlength="4" name="startdate" value="<?php echo $startdate; ?>" class="text-input">
                            </div>
                            <div>
                                <label>End Year <span class="note">(Leave blank if you are not updating the End Year)</span></label>
                                <input type="number" maxlength="4" name="enddate" value="<?php echo $enddate; ?>" class="text-input">
                            </div>
                            <div>
                                <button type="submit" name="update-educbg" class="btn btn-big">Submit</button>
                            </div>
                        </form>
                </div>
            </div>
