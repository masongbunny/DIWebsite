...
<html lang="en">
    ...
    <head>
        ...
        <title>Super Admin Section - Edit Announcement</title>
    ...
    <body>
        ...
        <div class="admin-wrapper">
            ...
            <div class="admin-content">
                ...
                <div class="content">
                    <h2 class="page-title">Edit Announcement Details</h2>
                    ...
                    <form action="create.php" method="post" enctype="multipart/form-data">
                        ...
                        <div>
                            <button type="submit" name="update-announcement" class="btn btn-big">Update Announcement</button>
                        </div>
                    </form>
                </div>
            </div>
