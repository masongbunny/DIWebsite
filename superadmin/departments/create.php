        ...
        <div class="admin-wrapper">
            ...
            <div class="admin-content">
                <div class="button-group">
                    <a href="index.php" class="btn btn-big">Back to Departments</a>
                </div>
                <div class="content">
                    ...
                    <form action="create.php" method="post" enctype="multipart/form-data">
                        ...
                        <div>
                            ...
                            <textarea class="text-input" name="description" required> <?php echo $description ?> </textarea>
                        </div>
                        <div>
                            <label>Display Image</label>
                            <input type="file" name="display_art" value="<?php echo $display_art; ?>" class="text-input" required>
                        </div>
                        <div>
                            <label>About </label>
                        ...
                        <div>
                            ...
                            <input type="file" name="org_chart" value="<?php echo $org_chart; ?>" class="text-input" required>
                        </div>
                        <div>
                            <label>Contact Information </label>
                            <textarea class="text-input" name="contact" required> <?php echo $contact ?> </textarea>
                        </div>
                        <div>
                            <button type="submit" name="add-unit" class="btn btn-big">Add New Unit</button>
                        </div>
                    </form>
                </div>
            </div>
