...
<html lang="en">
    ...
    <head>
        ...
        <title>Super Admin Section - Edit Form</title>
            ...
            <div class="admin-content">
                ...
                <div class="content">
                    ...
                    <form action="edit.php" method="post" enctype="multipart/form-data">
                        ...
                        <div>
                            <label>File <span class="note"> NOTE: LEAVE THIS BLANK IF YOU ARE NOT UPDATING THE FILE ATTACHMENT!</span></label>
                        ...
                        <div>
                            <button type="submit" name="update-form" class="btn btn-big">Update Form</button>
                        </div>
                    </form>
                </div>
            </div>
