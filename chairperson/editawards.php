                    ...
                    <?php include(ROOT_PATH . "/app/helpers/formErrors.php"); ?>
                        <form action="editawards.php" method="post" enctype="multipart/form-data">
                            <div>
                                ...
                                <input type="text" name="eventname" value="<?php echo $eventname; ?>" class="text-input">
                            </div>
                            <div>
                                <label>Award Name</label>
                                <input type="text" name="awardname" value="<?php echo $awardname; ?>" class="text-input">
                            </div>
                            <div>
                                <label>Date</label>
                                <input type="date" name="awarddate" value="<?php echo $awarddate; ?>" class="text-input">
                            </div>
                            <div>
                            ...
                            <div>
                                <button type="submit" name="update-awards" class="btn btn-big">Submit</button>
                            </div>
                        </form>
                </div>
            </div>
