...
$entries = selectAllGallery('gallery', ['department' => 'Arts and Sciences']);
?>
<!DOCTYPE html>
<html>
<head>
	...
	<title>Office of the Director for Instructions - Instruction Units - <?php echo $name; ?></title>
	...
	<div class="container ">
		<div class="row custom-section d-flex align-items-center">
			...
			<div class="col-12 col-lg-4">
				<img src="<?php echo BASE_URL . '/assets/images/' . $display_art; ?>" alt="Home Banner">
			</div>	
		</div>
	</div>
</div>	
	...
	<div class="demo">
		<div class="container">
			...
			<div class="row">
				...
				<div class="team">	
					<p class="description-mission"><?php echo $about_info; ?></p>
				</div>
				</div>
			</div>
		</div>	
