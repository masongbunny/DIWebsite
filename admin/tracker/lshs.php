...
<?php include(ROOT_PATH . "/app/controllers/tracker_lshs.php"); 
adminOnly();
...
<html lang="en">
    ...
    <head>
        ...
        <title>Admin Section - LSHS Requirements</title>
        ...
        <div class="admin-wrapper">
            ...
            <div class="admin-content">
                <div class="button-group">
                    ...
                    <a href="lshs.php" class="btn btn-big">Manage Tracker</a>
                    <form class="search" action="lshs.php" method="post">
                ...
                <div class="content">
                    <div class="skills-bar">
                        <div class="bar">
                            <div class="bar-info">
                                <span>LSHS Submission Status: <?php echo $gen_status; ?>% (<?php echo $submitted_count; ?> / <?php echo $sub; ?>)</span>
                            </div>
                ...
                <button class="btn btn-big excel" onclick="exportTableToExcel('tblData','LSHS Submitted Requirements Data')">Export Table Data</button>
            </div>

            <div class="content sec-below">                    
                    <h2 class="page-title">LSHS Faculty Submission Report</h2>
                    <?php include(ROOT_PATH . "/app/includes/messages.php"); ?>
                    <div class="container test">
                            <table id = "tblData1">
                                <thead>
                ...
                <button class="btn btn-big excel" onclick="exportTableToExcel('tblData1','LSHS Faculty Submission Report')">Export Table Data</button>
