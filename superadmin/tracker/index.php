                ...
                <div class="content">
                    <div class="skills-bar">
                        <div class="bar">
                            ...
                            <h2 class="page-title">General Submission Progress</h2>
                            <div class="bar-info">
                    ...
                    <h2 class="page-title">Requirements Submission Tracker <p class="note">Table shows all submitted requirements for AY: <?php echo $current_ay; ?>, <?php echo $current_sem; ?> sem!</p> </h2>
                    
                    <div class="tracker-sorter">
                        <form action="index.php" method="post">
                            Sort by Requirement:
                            <select name="id" class="req-sort" required>
                                <option value=""><?php echo $req_name; ?></option>
