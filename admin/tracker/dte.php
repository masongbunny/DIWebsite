...
<?php include(ROOT_PATH . "/app/controllers/tracker_dte.php"); 
adminOnly();
...
<html lang="en">
    ...
    <head>
        ...
        <title>Admin Section - DTE Requirements</title>
        ...
        <div class="admin-wrapper">
            ...
            <div class="admin-content">
                <div class="button-group">
                    ...
                    <a href="dte.php" class="btn btn-big">Manage Tracker</a>
                    <form class="search" action="dte.php" method="post">
                ...
                <div class="content">
                    <div class="skills-bar">
                        <div class="bar">
                            <div class="bar-info">
                                <span>DTE Submission Status: <?php echo $gen_status; ?>% (<?php echo $submitted_count; ?> / <?php echo $sub; ?>)</span>
                            </div>
                    ...
                    <h2 class="page-title">DTE Submitted Requirements Tracker</h2>
                ...
                <button class="btn btn-big excel" onclick="exportTableToExcel('tblData','DTE Submitted Requirements Data')">Export Table Data</button>
            </div>

            <div class="content sec-below">                    
                    <h2 class="page-title">DTE Faculty Submission Report</h2>
                    <?php include(ROOT_PATH . "/app/includes/messages.php"); ?>
                    <div class="container test">
                            <table id = "tblData1">
                                <thead>
                ...
                <button class="btn btn-big excel" onclick="exportTableToExcel('tblData1','DTE Faculty Submission Report')">Export Table Data</button>
