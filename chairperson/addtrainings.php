        ...
        <div class="admin-wrapper">
            ...
            <div class="admin-content">
                ...
                <div class="content dp-box1">
                    <h2 class="page-title">Trainings/Seminars - Add</h2>

                    <?php include(ROOT_PATH . "/app/helpers/formErrors.php"); ?>
                        <form action="addtrainings.php" method="post" enctype="multipart/form-data">
                            <div>
                                <input type="text" name="empid" value="<?php echo $_SESSION['empid']; ?>" class="text-input" hidden>
                                <label>Event Title</label>
                                <input type="text" name="eventtitle" value="<?php echo $eventtitle; ?>" class="text-input" required>
                            </div>
                            <div>
                                <label>Location</label>
                                <input type="text" name="location" value="<?php echo $location; ?>" class="text-input" required>
                            </div>
                            <div>
                                <label>Speaker</label>
                                <input type="text" name="speaker" value="<?php echo $speaker; ?>" class="text-input" required>
                            </div>
                            <div>
                                <label>Date</label>
                                <input type="date" name="eventdate" value="<?php echo $eventdate; ?>" class="text-input" required>
                            </div>
                            <div>
                                <label>File</label>
                            ...
                            <div>
                                <button type="submit" name="addtraining" class="btn btn-big">Submit</button>
                            </div>
                        </form>
                </div>
            </div>
