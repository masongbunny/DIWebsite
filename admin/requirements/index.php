...
<html lang="en">
    ...
    <head>
        ...
        <title>Admin Section - Manage Faculty Requirements</title>
        ...
        <div class="admin-wrapper">
            ...
            <div class="admin-content">
                <div class="button-group">
                    <a href="create.php" class="btn btn-big">Add New Requirement</a>
                        ...
                        <tbody>
                            <?php foreach ($reqs as $key => $req): ?>
                                <tr>
                                    ...
                                    <td><a href="index.php?adelete_id=<?php echo $req['req_id']; ?>" class="delete">delete</a></td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
                    </table>
