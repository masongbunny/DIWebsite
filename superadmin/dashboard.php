...
<html lang="en">
    ...
    <body onload=display_ct();>
        ...
        <div class="admin-wrapper ">
            ...
            <!-- Admin Content -->
            <div class="admin-content bg-color">
                <div class="content">
                                ...
                                <div class="row z-depth-3">
                                    <div class="col-sm-3 dpbg rounded-left text-white">
                                        <div class="card-block text-center text-white">
                                            ...
                                            <div class="dp-button">   
                                                <a href="editacadyeardetails.php" class="btn btn-big">Update Academic Year</a>
                                            </div>
                                            <div class="dp-button">   
                                                <a href="editcontacts.php" class="btn btn-big">Update Contact Emails</a>
                                            </div>
                                        </div>
                                        
                                    </div>
                                    <div class="col-sm-9 profile-content bg-light">
