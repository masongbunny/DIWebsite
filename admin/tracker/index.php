...
<html lang="en">
    ...
    <head>
        ...
        <title>Admin Section - Requirements Tracker</title>
        ...
        <div class="admin-wrapper">
            ...
            <div class="admin-content">
                <div class="button-group">
                    ...
                    <a href="index.php" class="btn btn-big">Manage Tracker</a>
                ...
                <div class="content">
                    <div class="skills-bar">
                        <div class="bar">
                            <div class="bar-info">
                                <span>General Submission Status: <?php echo $gen_status; ?>% (<?php echo $submitted_count; ?> / <?php echo $sub; ?>)</span>
                            </div>
                    ...
                    <h2 class="page-title">Submitted Requirements Tracker <p class="note">Table shows all submitted requirements for AY: <?php echo $current_ay; ?>, <?php echo $current_sem; ?> sem!</p> </h2>
