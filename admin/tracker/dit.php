...
<?php include(ROOT_PATH . "/app/controllers/tracker_dit.php"); 
adminOnly();
...
<html lang="en">
    ...
    <head>
        ...
        <title>Admin Section - DIT Requirements</title>
        ...
        <div class="admin-wrapper">
            ...
            <div class="admin-content">
                <div class="button-group">
                    ...
                    <a href="dit.php" class="btn btn-big">Manage Tracker</a>
                    <form class="search" action="dit.php" method="post">
                ...
                <div class="content">
                    <div class="skills-bar">
                        <div class="bar">
                            <div class="bar-info">
                                <span>DIT Submission Status: <?php echo $gen_status; ?>% (<?php echo $submitted_count; ?> / <?php echo $sub; ?>)</span>
                            </div>
                    ...
                    <h2 class="page-title">DIT Submitted Requirements Tracker</h2>
                    
                    <div class="tracker-sorter">
                        <form action="dit.php" method="post">
                            Sort by Requirement:
                ...
                <button class="btn btn-big excel" onclick="exportTableToExcel('tblData','DIT Submitted Requirements Data')">Export Table Data</button>
            </div>

            <div class="content sec-below">                    
                    <h2 class="page-title">DIT Faculty Submission Report</h2>
                    <?php include(ROOT_PATH . "/app/includes/messages.php"); ?>
                    <div class="container test">
                            <table id = "tblData1">
                                <thead>
                ...
                <button class="btn btn-big excel" onclick="exportTableToExcel('tblData1','DIT Faculty Submission Report')">Export Table Data</button>
