...
?>
<?php $years = range(2015, strftime("%Y", time())+1); ?>
                    ...
                    <form action="editacadyeardetails.php" method="post">
                        ...
                        <div>
                            ...
                            <select name="current_semester" class="text-input" required>
                                <option value="<?php echo $current_semester ?>" required><?php echo $current_semester ?></option>
                        ...
                        <div>
                            <button type="submit" name="update-aydetails" class="btn btn-big">Update Details</button>
                        </div>
                    </form>
                </div>
            </div>
