...
<?php include(ROOT_PATH . "/app/controllers/tracker_dept.php"); 
chairpersonOnly();
...
<html lang="en">
    ...
    <head>
        ...
        <title>Chairperson Section - Department Requirements Tracker</title>
    ...
    <body>
        ...
        <div class="admin-wrapper">
            ...
            <div class="admin-content">
                ...
                <div class="content">
                    <div class="skills-bar">
                        <div class="bar">
                            <div class="bar-info">
                                <span><?php echo $_SESSION['department']; ?> Submission Status: <?php echo $gen_status; ?>% (<?php echo $submitted_count; ?> / <?php echo $sub; ?>)</span>
                            </div>
                            <div class="progress-line"><span style="<?php echo $style_t1; ?>"></span></div> 
                            
                        </div>
                    </div>    
                    <h2 class="page-title"><?php echo $_SESSION['department']; ?> Submitted Requirements Tracker</h2>
            ...
            <div class="content sec-below">                    
                    <h2 class="page-title"><?php echo $_SESSION['department']; ?> Faculty Submission Report</h2>
                    <?php include(ROOT_PATH . "/app/includes/messages.php"); ?>
                    <div class="container test">
                            <table id = "tblData1">
                                <thead>
