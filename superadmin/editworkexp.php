        ...
        <div class="admin-wrapper">
            ...
            <div class="admin-content">
                ...
                <div class="content dp-box1">
                    <h2 class="page-title">Work Experience - Edit</h2>
                    ...
                    <?php include(ROOT_PATH . "/app/helpers/formErrors.php"); ?>
                        <form action="addworkexp.php" method="post">
                            <div>
                                ...
                                <input type="text" name="companyname" value="<?php echo $companyname; ?>" class="text-input">
                            </div>
                            <div>
                            ...
                            <div>
                                <label>From</label>
                                <input type="date" name="startdate" value="<?php echo $startdate; ?>" class="text-input">
                            </div>
                            <div>
                                <label>To</label>
                                <input type="date" name="enddate" value="<?php echo $enddate; ?>" class="text-input">
                            </div>
                            <div>
                                <button type="submit" name="update-workexp" class="btn btn-big">Submit</button>
                            </div>
                        </form>
                </div>
            </div>
