...
<html lang="en">
    ...
    <head>
        ...
        <title>Faculty Section - Add Work Experience</title>
        ...
        <div class="admin-wrapper">
            ...
            <div class="admin-content">
                ...
                <div class="content dp-box1">
                    <h2 class="page-title">Work Experience - Add</h2>

                    <?php include(ROOT_PATH . "/app/helpers/formErrors.php"); ?>
                        <form action="addworkexp.php" method="post">
                            <div>
                                <input type="text" name="empid" value="<?php echo $_SESSION['empid']; ?>" class="text-input" hidden>
                                <label>Company/Organization Name</label>
                                <input type="text" name="companyname" value="<?php echo $companyname; ?>" class="text-input" required>
                            </div>
                            <div>
                            ...
                            <div>
                                <label>From</label>
                                <input type="date" name="startdate" value="<?php echo $startdate; ?>" class="text-input" required>
                            </div>
                            <div>
                                <label>To</label>
                                <input type="date" name="enddate" value="<?php echo $enddate; ?>" class="text-input" required>
                            </div>
                            <div>
                                <button type="submit" name="addworkexp" class="btn btn-big">Submit</button>
                            </div>
                        </form>
                </div>
            </div>
