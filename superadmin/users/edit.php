...
<html lang="en">
    ...
    <head>
        ...
        <title>Super Admin Section - Edit User Account</title>
                ...
                <div class="content">
                    ...
                    <form action="edit.php" method="post">
                        <div>
                            ...
                            <input type="text" name="empid" value="<?php echo $empid; ?>" class="text-input no-edit">
                        </div>
                        <div>
                        ...
                        <div>
                            <label>Password <span class="note">(NOTE: Leave this blank if you are not updating user's password)</span></label>
                            <input type="password" name="password" value="<?php echo $password; ?>" class="text-input">
                        </div>
                        <div>
                            <label>Password Confirmation <span class="note">(NOTE: Leave this blank if you are not updating user's password)</span></label>
                        ...
                        <div>
                            ...
                            <select name="rank" class="text-input">
                                ...
                                <option value="ODI Staff">ODI Staff</option>
