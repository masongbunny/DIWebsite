...
if(isset($_POST['search-term'])){
    $faqs = searchFaqs($_POST['search-term']);
} else{
    $faqs = selectAll('faq');
}
...
<html lang="en">
    ...
    <head>
        ...
        <title>Super Admin Section - Frequently Asked Questions</title>
        ...
        <div class="admin-wrapper">
            ...
            <div class="admin-content">
                <div class="button-group">
                    <a href="create.php" class="btn btn-big">Add New</a>
