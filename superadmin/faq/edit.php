...
<html lang="en">
    ...
    <head>
        ...
        <title>Super Admin Section - Edit FAQ</title>
                ...
                <div class="content">
                    ...
                    <form action="create.php" method="post">
                        <div>
                            ...
                            <input type="text" name="question" value="<?php echo $question; ?>" class="text-input">
                        </div>
                        <div>
                            <label>Answer</label>
                            <textarea name="answer" id="body"><?php echo $answer ?></textarea>
                        </div>
                        <div>
                            <button type="submit" name="update-faq" class="btn btn-big">Update</button>
                        </div>
                    </form>
                </div>
            </div>
