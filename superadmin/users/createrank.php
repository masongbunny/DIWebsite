...
<html lang="en">
    ...
    <head>
        ...
        <title>Super Admin Section - Add User Rank</title>
        ...
        <div class="admin-wrapper">
            ...
            <div class="admin-content">
                <div class="button-group">
                    <a href="rankindex.php" class="btn btn-big">Back to Ranks</a>
                </div>
                <div class="content">
                    <h2 class="page-title">Add New Rank</h2>
                    ...
                    <form action="create.php" method="post">
                        ...
                        <div>
                            <button type="submit" name="create-rank" class="btn btn-big">Add</button>
                        </div>
                    </form>
                </div>
            </div>
