...
<html lang="en">
    ...
    <head>
        ...
        <title>Super Admin Section - Add New Announcement</title>
        ...
        <div class="admin-wrapper">
            ...
            <div class="admin-content">
                <div class="button-group">
                    <a href="index.php" class="btn btn-big">Back to Announcements</a>
                </div>
                <div class="content">
                    <h2 class="page-title">Add New Announcement</h2>
                    ...
                    <form action="create.php" method="post" enctype="multipart/form-data">
                        ...
                        <div>
                            <button type="submit" name="add-announcement" class="btn btn-big">Add Announcement</button>
                        </div>
                    </form>
                </div>
            </div>
